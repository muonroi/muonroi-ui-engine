...
// We derive them from Buffer (a Node.js built-in) whose prototype chain always points to native types.
...
// Polyfill IntersectionObserver for jsdom (used by ReactFlow)
...
// Polyfill DOMRect for jsdom (used by ReactFlow getBoundingClientRect)
